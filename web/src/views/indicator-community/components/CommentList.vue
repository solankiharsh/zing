<template>
  <div class="comment-list">
    <!-- Comment input (shown when can comment/edit) -->
    ...
    <!-- Already commented hint (cannot comment again, but can edit) -->
...
export default {
  ...
  watch: {
    // If myComment is passed in, auto-fill the form (for edit mode)
    myComment: {
      immediate: true,
      handler (val) {
