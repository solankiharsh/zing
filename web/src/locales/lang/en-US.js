...
const locale = {
  ...
  // Main trading dashboard (KPI cards, calendar, charts)
  ...
  'dashboard.label.maxDrawdownPoint': 'MAX',
  'dashboard.unit.trades': 'trades',
  'dashboard.unit.strategies': 'strategies',
  'dashboard.profitCalendar': 'Profit Calendar',
  'dashboard.noData': 'No Data',
  'dashboard.calendarEmptyDesc': 'Start trading to see daily P&L heat map.',
  ...
  'dashboard.addStrategy': 'Add Strategy',
  ...
  'dashboard.noStrategyData': 'No strategy data yet',
  ...
  'dashboard.newOrderNotify': 'New order',
  'dashboard.newOrderDesc': 'You have a new order notification',
  'dashboard.soundEnabled': 'Sound enabled',
  'dashboard.soundDisabled': 'Sound disabled',
  'dashboard.calendarDayClick': 'Day {day}: {amount}',
  ...
  'dashboard.table.entryPrice': 'Entry',
  'dashboard.table.pnl': 'P&L',
  ...
  'dashboard.orderTable.signalType': 'Signal',
  'dashboard.orderTable.amount': 'Amount',
  'dashboard.orderTable.price': 'Price',
  ...
  'dashboard.analysis.market.IndianStock': 'India',
  ...
  'dashboard.indicator.market.IndianStock': 'India',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR and MT5 are external trading interfaces that require local deployment of MarketLabs. Cloud SaaS mode is not supported. Please ensure you have installed and configured the trading software (TWS/IB Gateway or MT5 terminal) on your local machine.',
  ...
  'trading-assistant.form.indianBroker': 'Indian Broker',
  'trading-assistant.form.indianBrokerHint': 'Select your Indian stock broker for live trading',
  'trading-assistant.form.accessToken': 'Access Token',
  'trading-assistant.form.accessTokenHint': 'Generated daily via Kite login',
  'trading-assistant.form.clientId': 'Client ID',
  'trading-assistant.form.totpKey': 'TOTP Key',
  'trading-assistant.form.apiSecret': 'API Secret',
  'trading-assistant.form.mpin': 'MPIN',
  'trading-assistant.form.userId': 'User ID',
  'trading-assistant.form.totpCode': 'TOTP Code',
  'trading-assistant.exchange.indianBrokerConnectionSuccess': 'Indian broker connected successfully',
  'trading-assistant.exchange.indianBrokerConnectionFailed': 'Indian broker connection failed. Please check your credentials.',
  ...
  'globalMarket.indiaHeatmap': 'India',
  ...
  'fastAnalysis.systemTitle': 'MARKETLABS AI',
