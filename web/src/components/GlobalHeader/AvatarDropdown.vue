<template>
  <a-dropdown v-if="currentUser && currentUser.name" placement="bottomRight">
    <span class="ant-pro-account-avatar">
      <a-avatar size="small" :src="displayAvatar" class="antd-pro-global-header-index-avatar" />
...
export default {
  ...
  computed: {
    displayAvatar () {
      const av = (this.currentUser && this.currentUser.avatar) || ''
      if (!av || !av.trim()) return (typeof window !== 'undefined' && window.location ? window.location.origin + '/avatar2.jpg' : '/avatar2.jpg')
