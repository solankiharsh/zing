  ...
  <div class="setting-drawer">
    ...
    >
      <div class="setting-drawer-index-content">
        ...
        <!-- Page style (dark/light menu) hidden from UI -->
...
export default {
  ...
  mounted () {
    // Silently update theme color on initialization, without showing messages
  ...
  production: process.env.NODE_ENV === 'production' && process.env.VUE_APP_PREVIEW !== 'true'
    ...
    handleLayout (mode) {
      ...
      // Top menu mode cannot pin the left sidebar, so force disable it
      if (mode === 'topmenu') {
...
<style lang="less" scoped>
  /* Hide all possible floating buttons */
