...
export default {
  ...
  render () {
    ...
    return <div class="business-pro-ad"><a href="https://store.antdv.com/pro/" target="_blank">(Recommended) Enterprise Admin Pro is now available, built with Vue3 + TS.</a></div>;
  }
}
</script>
